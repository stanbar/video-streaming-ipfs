                ...
                <Grid container={true} spacing={24}>
                    ...
                    <Grid item={true} xs={true}>
                        ...
                        <Paper>
                            ...
                            <Typography
                                variant="body2">In: {(bandwidth.totalIn / 1024 / 1024).toFixed(2)} MB ({(bandwidth.rateIn / 1024).toFixed(2)} B/s)</Typography>
                            <Typography
                                variant="body2">Out: {(bandwidth.totalOut / 1024 / 1024).toFixed(2)} MB ({(bandwidth.rateOut / 1024).toFixed(2)} B/s)</Typography>
                        </Paper>
                        }
                    </Grid>
                    ...
                    <Grid item={true} xs={true}>
                        ...
                        <Paper>
                            ...
                            <Typography variant="body2">Received: {(bitswap.dataReceived / 1024 / 1024).toFixed(2)} MB</Typography>
                            <Typography variant="body2">Sent {(bitswap.dataSent / 1024 / 1024).toFixed(2)} MB</Typography>
                    ...
                    <Grid item={true} xs={true}>
                        ...
                        <Paper>
                            ...
                            <Typography variant="body2">Size {(repo.repoSize / 1024 / 1024).toFixed(2)} MB</Typography>
                        </Paper>
                        }
                    </Grid>
                </Grid>
